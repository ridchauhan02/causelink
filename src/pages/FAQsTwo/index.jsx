  ...
  return (
    <>
      <div className="bg-gray-900 flex flex-col font-judson items-center justify-start mx-auto pb-[86px] w-full">
        ...
        <div className="bg-deep_purple-300_3a flex flex-col font-inter gap-2 items-center justify-center max-w-[1205px] mt-[97px] mx-auto p-7 md:px-5 w-full">
          <Text
          ...
          <div className="flex flex-col items-start justify-start mb-24 w-full">
            ...
            <div className="h-[447px] md:h-[483px] mt-9 relative w-full">
              ...
              >
                <>
                  ...
                  <br />
                  <br />
                  Cause link’s platform for volunteers looking for ways to help
                  in <br />
                  their communities to find opportunities and organizations that{" "}
                  <br />
                  need their time, talents and passion. Nonprofits can register
                  their organizations, curate a profile of their volunteer
                  programs and needs, and keep their volunteer events and
                  ongoing opportunities up to date through the platform’s
                  posting app.
                </>
              </Text>
            </div>
            <div className="h-[370px] relative w-full">
              ...
              >
                <>
                  ...
                  aggregation services of All For Good now power the catalog at
                  Cause link, with updates to the design, search and filtering
                  features. AllForGood.
                </>
              </Text>
            </div>
            ...
            >
              ...
              <span className="text-white-A700 font-inter text-left font-medium">
                <>
                  ...
                  through our new white label offering. Get in touch with us for
                  more information.
                </>
              </span>
            </Text>
            ...
            >
              ...
              <span className="text-white-A700 font-inter text-left font-medium">
                The first step in our registration system uses information from
                Google to identify your organization and its place-oriented
                business data (address, website, etc.) Google has most US-based
                registered 501c3 organizations in their system already, but if
                you have trouble finding yours in the search, you will need to
                add it to Google’s database at Google My Business. There are a
                lot of good reasons to do this beyond enabling you to register
                with cause link. Having a profile for your organization in
                Google will help people discover your important mission in
                search and maps!
              </span>
            </Text>
          </div>
